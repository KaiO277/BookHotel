...
import com.example.hoangbao.Adapter.ShowRoomHistoryAdapter;
...
public class BookingHistory extends AppCompatActivity {
    ...
    ShowRoomHistoryAdapter roomAdapter;
    TextView title;
    ...
    private void initControl() {
        ...
        compositeDisposable.add(apiBookingHotel.showRoom(maKH, 1)
                ...
                .subscribe(
                        showRoomModel -> {
                            if(showRoomModel.isSuccess()){
                                ...
                                roomAdapter = new ShowRoomHistoryAdapter(getApplicationContext(), showRooms);
